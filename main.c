...
int main() {
	...
	printf("Object is of type: %s\n", instance_point->type->name.str);
	printf("Object data size: %zu\n", instance_point->type->size);
	printf("Point implement Format = %d\n", Type_implement(instance_point->type, trait_Format));
	printf("Point implement Move2i = %d\n", Type_implement(instance_point->type, trait_Move2i));
	printf("Point implement Move3f = %d\n", Type_implement(instance_point->type, trait_Move3f));

	LINE_BREAK();

	Object* instance_vector3f = Object_new(type_Vector3f);
	printf("Object is of type: %s\n", instance_vector3f->type->name.str);
	printf("Object data size: %zu\n", instance_vector3f->type->size);
	printf("Point implement Format = %d\n", Type_implement(instance_vector3f->type, trait_Format));
	printf("Point implement Move2i = %d\n", Type_implement(instance_vector3f->type, trait_Move2i));
	printf("Point implement Move3f = %d\n", Type_implement(instance_vector3f->type, trait_Move3f));
	...
	*(uint64_t*)instance_uint64->data = 512;
	...
	printf("Point implement Format = %d\n", Type_implement(instance_uint64->type, trait_Format));
	printf("Point implement Move2i = %d\n", Type_implement(instance_uint64->type, trait_Move2i));
	printf("Point implement Move3f = %d\n", Type_implement(instance_uint64->type, trait_Move3f));
